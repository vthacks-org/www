    ...
    <div class="volunteer-content">
      ...
      <div class="info-term">
        <p>$> <span style="color: #48d247;">INFO: </span> Want to help us out? VTHacks
          always needs volunteers to help during the event. You don't need any special skills but
          if you have any questions please <a href="mailto:yahui624@vt.edu">email us</a>.</p>
      </div>

      <div class="actions">
        <a href="https://www.signupgenius.com/go/9040e48afac2babf85-vthacks" target="_blank" class="register-link big neon-pink eightbit-btn">Volunteer &gt;</a>
